...
test_out = '/home/srq/Datasets/tables/unlv-for-table-parsing-2/test'
train_out = '/home/srq/Datasets/tables/unlv-for-table-parsing-2/train'
validate_out = '/home/srq/Datasets/tables/unlv-for-table-parsing-2/validate'
...
class UnlvConverter:
    ...
    def see_table(self, table, increment):
        ...
        spatial_features = model.get_feature_map(image_table_cropped).astype(np.float64)
        ...
        self.dump_table(all_tokens, all_tokens_rects, M, D, row_share_matrix, col_share_matrix, cell_share_matrix, neighbors_same_row, neighbors_same_col, neighbors_same_cell, show_1, spatial_features, os.path.join(sorted_path_full, '__dump__.pickle'))
